...
using fileCabinets.Engine;
using fileCabinets.Structs;
using fileCabinets.Utility;

namespace fileCabinets
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        private void saveTestBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (p.addNode(new StringNode("firstName", "John"))) msgBox.Text += "Added firstName - Node Count: " + p.getNodes().Count + "\n";
            if (p.addNode(new StringNode("lastName", "Smith"))) msgBox.Text += "Added lastName - Node Count: " + p.getNodes().Count + "\n";
            ...
            p.addNode(new StringNode("firstName", "Jane"));
            f.addPage(p);
            p = new Structs.Page(f.idIncrement());
            p.addNode(new StringNode("firstName", "Steven"));
            f.addPage(p);
            d.addFolder(f);
            msgBox.Text += "Created drawer\n";
